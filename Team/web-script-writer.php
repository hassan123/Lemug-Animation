  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/content-writer/Astrid.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/content-writer/Astrid.jpg)">
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Asrid is a comic book nerd from Edinburgh who has already won a host of awards in screen writing.  It Takes the Notion and Ammonite is her first features.  Russell T Davies - Doctor Who - is her mentor on the BFI flare scheme.  </p>

  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/designers/Jolie.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/designers/Jolie.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Jolie Reed specializes in creating brands and digital experiences. Her wide range of experience includes creating visual identities for large brands as well as designing mobile apps for tech startups. Besides taking one sugar with her tea she is passionate about the processes of design and loves photography. </p>
    </div>

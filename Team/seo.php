  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/digital-marketer/alex.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/digital-marketer/alex.jpg)">
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Alex has been working alongside clients to increase traffic to their websites and implement their Digital Marketing strategies. With his vast technical knowledge and experience he enables clients to achieve their SEO goals, pushing them ahead of their competitors and optimizing their conversion rates.
Other than his passion for SEO, he loves to feel the breeze when riding his motorcycle. </p>

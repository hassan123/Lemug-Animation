...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Graphic Designer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/designers/Chris.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/designers/Chris.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Chris leads our design ensuring to deliver engaging, memorable and inspiring solutions. Combining creativity with strategic insight, Chris helps brands maximize their impact in the marketplace. With a passion for visual communication and brand creativity, Chris works across a range of disciplines from branding and advertising through to interiors and online. When not in the studio, Chris can usually be found wandering around the opposition's penalty box for his local footy team.</p>
    </div>

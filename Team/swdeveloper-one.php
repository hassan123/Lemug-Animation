  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/software-developer/alex.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/software-developer/alex.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Alex Silva is an experienced developer who works on both front end and back end. He has been with KD web since 2011 and has a Bsc and an MSc in IT and loves working with TYPO3 and Magento. </p>
       <p class="project-copy">
Outside of work, like Bobby Cliff said - he don't like cricket, he love it!</p>
    </div>

...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Game Programmer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/game/stefan.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/game/stefan.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">stefan takes care of programming and game design. Armed with logic and maths there's nothing Atul can't build! </p>
<p class="project-copy">He earned his stripes during university studying computer science. He survived by exchanging PC repairs for vodka with the 5 art students he lived with. Despite losing his love for vodka, all things computery still engage him. </p>
<p class="project-copy">Atul took his first steps into video game production with a program combining a virtual pet hamster with Tetris. Awesome.</p>
    </div>

...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">HR Manager</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/HR/Zoya.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/HR/Zoya.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Monica is a qualified and experienced HR and Organizational Development professional. With over five years strategic and operational human resource and learning and development experience, she delivers innovative human resource solutions in private, public and not for profit sectors. Monica is highly adaptable and flexible and works on both small and large scale projects. An experienced coach and business partner, she has a dynamic and energetic approach towards developing practices that drive high performance. </p>

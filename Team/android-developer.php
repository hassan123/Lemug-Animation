...
<h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Android Developer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/mobile/nick.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/mobile/nick.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Nick is a key part of our development team. He boasts special skills in skiing and genetics (we’ll find a use for that one day).</p>
    </div>

...
<meta charset="utf-8">
<title>Internet Marketing Manager</title>
  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/digital-marketer/anaya.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/digital-marketer/anaya.jpg)">
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Anaya has a BSc. degree in Psychology. Although she hasn’t quite perfected her mind reading skills she has used her insights to forge strong customer relationships and develop creative online marketing strategies.
In her spare time she loves nothing more than discovering London on her bike. </p>

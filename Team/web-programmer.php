...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Web Programmer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/web-developer/nitin.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/web-developer/nitin.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Natin is an expert at developing the technical mumbo-jumbo that goes on behind the pictures you see on your computer screen. With an initial background in digital marketing, Sam has combined this with her web development expertise to ensure a smooth and engaging user experience for your clients when they browse your website.</p>
    </div>

...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Developer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/software-developer/elizbeth.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/software-developer/elizbeth.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Elizabeth is a dedicated digital designer who holds multiple qualifications in design including BA Hons. in Visual Communication. 
She is passionate about digital design but simultaneously is also in love with vintage - believing everything was much more beautiful in 19th century without technology, one of the reasons she prefers analogue cameras because the film always gives unexpected surprises.</p>
    </div>

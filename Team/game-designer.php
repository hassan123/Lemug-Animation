...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">Game Designer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/designers/Robin.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/designers/Robin.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Tom is our artist and co game designer. Ruling over all visual aspects of game design with an unrelenting attention to detail. Tom will occasionally attempt to write code with disastrous and laughable results!  A graduate of fine art, Tom’s love for visual communication and storytelling is what floats his boat, as well as sharing what it means to be human through the abstract and limitless world of video games!</p>
    </div>

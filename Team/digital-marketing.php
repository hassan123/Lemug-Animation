  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/digital-marketer/jane.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/digital-marketer/jane.jpg)">
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Jane is our Digital marketer, currently completing her placement here at Wantro for her Marketing/Advertising degree. She’s a social media fanatic, has a passion for creative advertising and a love for all things design related. When she’s not working on her next assignment, or living the intern dream here, she’s either out and about exploring the hidden treasures of Auckland, practicing her hand at photography, or at home scrolling through Pinterest. </p>

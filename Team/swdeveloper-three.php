  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/software-developer/russell.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/software-developer/russell.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Supported by years of experience in software engineering and web/app development, Russell thrives on complex and challenging projects, and always manages to outshine expectations. 
When not studying R&D in new web technologies, Russell likes to think of himself as a bit of an Eric Clapton, serenading his wife with beautiful riffs…!</p>
    </div>

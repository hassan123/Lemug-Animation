  ...
  <div class="project-content">
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/designers/Dario.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/designers/Dario.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Dario recently graduated with a degree in Communication Design, Dario is our Junior Creative here at Wantro. Although he takes on whatever projects come his way, whether it be branding or web design; he is currently immersing himself in the world of virtual reality and 360 video. When he doesn’t have a headset on, Dario likes to spend his spare time painting and mixing music.</p>
    </div>

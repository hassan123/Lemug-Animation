...
<div class="project" style="opacity: 1; display: block;">
  <div class="project-content">
    <h2 class="project-title inner-content delay-fade do-change-title" style="opacity: 1;">UI / UX Designer</h2>
    ...
    <div class="project-gallery gallery-wrapper">
      ...
      <div class="gallery delay-fade do-change-gallery" style="opacity: 1;">
        <div class="content">
        <div class="gallery-item active" data-item="0" style="background-image: url(images/mobile/jacquline.jpg); opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
        </div>

    <div class="gallery-item" data-item="1" style="background-image: url(images/mobile/jacquline.jpg)"></div>
  </div>
      </div>
    </div>
    ...
    <div class="project-description inner-content delay-fade do-change-description" style="opacity: 1;">
      ...
      <p class="project-copy">Jacqueline deals with all things innovation and design; from creating icons for Wantro website, to branding and shaping visuals for client apps and web systems.
After graduating from Central Saint Martins with a Degree in Product Design, Jacqueline  followed her interest in how users interact with technology, to shape a career in UX/UI design. As lead designer, Jacqueline's main task is to understand a client's app idea and take it from a concept to an intuitive user journey that is attractive and fulfills the requirements laid out by the client.</p>
<p>Jacqueline's favorite app is Fashtagd because she enjoyed mixing her interest of fashion with design to work on this project.</p>
    </div>
